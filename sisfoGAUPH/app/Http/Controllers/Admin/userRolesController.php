...
class userRolesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!empty($keyword)) {
            ...
            $userroles = userRole::latest()->paginate($perPage);
        }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/user-roles')->with('flash_message', 'userRole added!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/user-roles')->with('flash_message', 'userRole updated!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/user-roles')->with('flash_message', 'userRole deleted!');
    }
}
