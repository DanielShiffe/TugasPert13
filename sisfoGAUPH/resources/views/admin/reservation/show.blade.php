                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> User Id </th><td> {{ $reservation->user_id }} </td></tr><tr><th> Reservation Code </th><td> {{ $reservation->reservation_code }} </td></tr><tr><th> Room Id </th><td> {{ $reservation->room_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
